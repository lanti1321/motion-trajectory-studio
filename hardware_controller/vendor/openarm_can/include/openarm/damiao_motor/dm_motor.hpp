...
public:
    ...
    int get_error_code() const { return state_error_code_; }
...
protected:
    ...
    void update_state(double q, double dq, double tau, int tmos, int trotor, int error_code);
    ...
    int state_tmos_, state_trotor_, state_error_code_;
