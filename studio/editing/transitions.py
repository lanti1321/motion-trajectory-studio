...
def concatenate(
    ...
    if set(first.channels) != set(second.channels):
        raise ValueError("trajectories must have the same channels before splicing")
...
def splice_at(
    ...
    if set(data.channels) != set(inserted.channels):
        raise ValueError("spliced trajectories must have the same channels")
