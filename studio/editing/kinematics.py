...
class KinematicsEngine:
    ...
    def cartesian_offset_window(
        ...
        if key > first:
            ...
            entry_u = (solve_frames[before] - first) / (key - first)
            weights[before] = entry_u**3 * (
                10.0 - 15.0 * entry_u + 6.0 * entry_u**2
            )
        ...
        if key > first:
            ...
            dense_entry_u = (all_frames[dense_before] - first) / (key - first)
